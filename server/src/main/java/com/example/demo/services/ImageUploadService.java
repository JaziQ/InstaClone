...
public class ImageUploadService {
    ...
    public ImageModel getImageToUser(Principal principal) {
        ...
        else throw new ImageNotFoundException("Something went wrong in profile" + principal.getName());
        return imageModel;
    }
    ...
    protected byte[] compressBytes(byte[] data) {
    ...
    protected static byte[] decompressBytes(byte[] data) {
